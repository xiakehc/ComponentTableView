#
#  Be sure to run `pod spec lint ComponentTableView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "WPDreamMelody" => "email@address.com" }
  # Or just: s.author    = "WPDreamMelody"
  # s.authors            = { "WPDreamMelody" => "email@address.com" }
  # s.social_media_url   = "http://twitter.com/WPDreamMelody"
